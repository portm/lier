...
StringLiteral "string"
  = '"' chars:DoubleStringCharacter* '"' {
      return { type: types.string, value: chars.join("") };
    }
...
NullLiteral
  = NullToken { return { type: types.null }; }

BooleanLiteral
  = TrueToken  { return { type: types.boolean, value: true }; }
  / FalseToken { return { type: types.boolean, value: false }; }
...
NumericLiteral "number"
  = literal:HexIntegerLiteral !(IdentifierStart / DecimalDigit) {
      return { type: types.number, value: literal };
    }
...
RegularExpressionLiteral "regular expression"
  = "/" pattern:$RegularExpressionBody "/" flags:$RegularExpressionFlags {
      ...
      return { type: types.regular, value: value };
    }
